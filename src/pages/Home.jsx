  ...
  return <Helmet title={'Home'}>
      ...
      <Container>
        <Row>
          <Col lg='6' md='6'>
            ...
            <h2>Find your perfect fit<br/> at our store today</h2>
    ...
    <section className='timer_count'>
      ...
      <Row>
        ...
        <div className='clock_top-content'>
          ...
          <h3 className='fs-5 mb-3'>Zipped Hoodie</h3>
        </div>
          <Clock/>
    ...
    <section className='new_arrivals'>
      <Container>
        ...
        <Col lg='12' className='text-center mb-5'>
            <h2 className='section_title mb-0'>New Arrivals</h2>
          </Col>
    ...
    <section className='popular_category'>
      <Container>
        <Row>
        <Col lg='12' className='text-center mb-5'>
            <h2 className='section_title mb-0'>Popular in Category</h2>
          </Col>
