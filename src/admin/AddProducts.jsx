          ...
          <Col lg='12' >
            ...
            <Form onSubmit={addProduct}>
              <FormGroup className='form_group'>
                ...
                <input type="text" placeholder="T-shirt" value={enterTitle} onChange={e=>setEnterTitle(e.target.value)} required/>
              </FormGroup>
              <FormGroup className='form_group'>
              ...
              <FormGroup className='form_group w-50'>
                <span>Price</span>
                <input type="number" placeholder="100 TND" value={enterPrice} onChange={e=>setEnterPrice(e.target.value)} required/>
              </FormGroup>
